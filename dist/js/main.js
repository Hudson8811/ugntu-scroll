...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-marquee')) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.form__close-btn').on('click', function (e) {
    e.preventDefault();
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  var slider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"]('.js-slider-single', {
    slidesPerView: 1.2,
    spaceBetween: 6,
    centeredSlides: true,
    navigation: {
