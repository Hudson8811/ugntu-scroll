...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('load', function () {
  ...
  } else if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y1980').length > 0) {
    __webpack_require__(/*! ./years/_y1980 */ "./src/js/import/years/_y1980.js");
  } else if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y1990').length > 0) {
    __webpack_require__(/*! ./years/_y1990 */ "./src/js/import/years/_y1990.js");
  } else if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y2000').length > 0) {
    __webpack_require__(/*! ./years/_y2000 */ "./src/js/import/years/_y2000.js");
  } else if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y2010').length > 0) {
    __webpack_require__(/*! ./years/_y2010 */ "./src/js/import/years/_y2010.js");
  } else {
...
function initAnimation() {
  ...
  b13Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y4-15').innerHeight();
  b14Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y4-16').innerHeight();
  b15Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y4-17').innerHeight();
...
function initScrollAnimationDesktop() {
  ...
  tl.fromTo(".y4-110__photos-item--1", {
    x: '100vw'
  }, {
    x: '50vw',
    duration: 1,
  ...
  tl1.fromTo(".y4-1__title--1 span:nth-child(3)", {
    x: '120vw',
    y: '100vh'
  }, {
    x: '-140vw',
...
function initScrollAnimationMobile() {
  ...
  var academicList;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js--y4-7').each(function () {
    var slider = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var academicList = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](slider[0], _defineProperty({
      slidesPerView: "1",
      spaceBetween: 16,
      loop: false,
      pagination: false,
...
function initAnimation() {
  scWidth = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.scroll-page').innerWidth();
  b1Width = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y5-1').innerWidth();
  b2Width = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y4-2').innerWidth();
  scHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.scroll-page').innerHeight();
  b1Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y5-1').innerHeight();
...
function initAnimation() {
  ...
  b2Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y6-2').innerHeight();
  b3Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y6-3').innerHeight();
  b4Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y6-4').innerHeight();
  b5Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y6-7').innerHeight();
  b6Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y6-8').innerHeight();
  b7Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y6-9').innerHeight();
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('resize', function () {
  ...
  if (dwidth !== wwidth) {
    ...
    tl.clear();
    tl2.clear();
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set(".y7-110,.y7-1__bg--1,.y7-110__numbers,.y7-110__numbers-number,.y7-110__numbers-line,.y7-110__photos,.y7-110__photos-item" + ".y7-100,.y7-100__numbers,.y7-100__numbers-number,.y7-100__numbers-line," + ".y7-1__bg, .y7-1__bg--1, .y7-1__2, .y7-1 .y7-1__year, .y7-1 .y7-1__text--1, .y7-1__title--4, .y7-1__title--5, .y7-1__title--3,  .y7-1__title--5, .y7-1__title--6, .y7-1__title--7, .y7-1__title--8" + ".y7-2" + ".y7-3__bg--1, .y7-3__title--1, " + ".y7-4__blockOverlay, .y7-4, .y7-4__2" + ".y7-5__blockOverlay, .y7-5" + ".y7-8__title--1" + ".y7-10__blockOverlay, .y7-10" + ".y7-11__title--1 span:nth-child(1), .y7-11__title--1 span:nth-child(2), .y7-11__title--1 span:nth-child(3), .y7-11__title--1 span:nth-child(4), .y7-11__2, .y7-11__1" + ".y7-14__blockOverlay, .y7-14" + ".y7-18__blockOverlay, .y7-18" + ".y7-19__blockOverlay, .y7-19" + ".y7-20__blockOverlay, .y7-20" + ".y7-21__1, " + ".y7-22__blockOverlay, .y7-22" + ".y7-23__2, .y7-23__text--1, .y7-23__3" + ".y7-24__1, " + ".y7-25__blockOverlay, .y7-25" + ".scroll-page,.sidebar__menu-dropdown, .fullPageOverlay", {
      clearProps: "all"
    });
    window.scrollTo({
      top: 0,
...
function initAnimation() {
  scWidth = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.scroll-page').innerWidth();
  b1Width = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-15').innerWidth();
  b2Width = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-20').innerWidth();
  scHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.scroll-page').innerHeight();
  b1Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-1').innerHeight();
  b2Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-2').innerHeight();
  b3Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-3').innerHeight();
  b4Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-4').innerHeight();
  b5Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-5').innerHeight();
  b6Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-10').innerHeight();
  b7Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-14').innerHeight();
  b8Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-18').innerHeight();
  b9Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-19').innerHeight();
  b10Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-20').innerHeight();
  b11Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-110').innerHeight();
  b12Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-22').innerHeight();
  b13Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y7-25').innerHeight();
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('resize', function () {
  ...
  if (dwidth !== wwidth) {
    ...
    tl.clear();
    tl2.clear();
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set(".y8-110,.y8-1__bg--1,.y8-110__numbers,.y8-110__numbers-number,.y8-110__numbers-line,.y8-110__photos,.y8-110__photos-item" + ".y8-100,.y8-100__numbers,.y8-100__numbers-number,.y8-100__numbers-line," + ".y8-1__bg,.y8-1__bg--1,.y8-1__title--1 span:nth-child(1),.y8-1__title--1 span:nth-child(2),.y8-1 .y8-1__year,.y8-1 .y8-1__text--1," + ".scroll-page,.sidebar__menu-dropdown, .fullPageOverlay", {
      clearProps: "all"
    });
    window.scrollTo({
      top: 0,
...
function initAnimation() {
  scWidth = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.scroll-page').innerWidth();
  b1Width = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y8-15').innerWidth();
  b2Width = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y8-20').innerWidth();
  scHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.scroll-page').innerHeight();
  b1Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y8-1').innerHeight();
  b2Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y8-2').innerHeight();
  b3Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y8-3').innerHeight();
  b4Height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.y8-4').innerHeight();
